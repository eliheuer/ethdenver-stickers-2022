...
def draw_main_type():
    ...
    text("REGEN>DEGEN", (MARGIN+39, MARGIN + (6*MARGIN)))
    text("REGEN>DEGEN", (MARGIN+39, MARGIN + (8*MARGIN)))
    text("REGEN>DEGEN", (MARGIN+39, MARGIN + (10*MARGIN)))
    text("REGEN>DEGEN", (MARGIN+39, MARGIN + (12*MARGIN)))

# Build and save the image
if __name__ == "__main__":
    draw_main_type()
    # Save output, using the "--output" flag location
    saveImage("quote-004-regen-degen-b.png")
