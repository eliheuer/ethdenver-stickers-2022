...
def draw_image():
    ...
    for axis, data in listFontVariations().items():
        print((axis, data))
    fontSize(144)
    #text("let's throw a coordination party", (MARGIN-0.5, MARGIN + (0*MARGIN)))
    text("Let's Throw a", (MARGIN-0.5, MARGIN + (2*MARGIN)))
    text("Coordination Party", (MARGIN-0.5, MARGIN + (1*MARGIN)))
...
if __name__ == "__main__":
    draw_image()
    saveImage("quote-008-coordination-party.png")
    print("DrawBot: Done :-)")
